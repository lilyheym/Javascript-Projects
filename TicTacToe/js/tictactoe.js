...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Active player may only be 'X' pr 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the o.png is plaved in HTML
            select.style.backgroundImage = 'url("images/o.png")';
        }
        //squareNumber and activePlayer are concentrated together and added to array
...
//draeLine() function is called to draw a line on the screen if the condtions are met
function checkWinConditions() {
    ...
    //This function checks if an array includes 3 stirngs. It is used to check for each win condition
    function arrayIncludes(squareA, squareB, squareC) {
        //These 3 variables will be used to check for 3 in a row
        const a = selectedSquares.includes(squareA);
        const b = selectedSquares.includes(squareB);
        const c = selectedSquares.includes(squareC);
        //If the 3 variables we pass are all ncluded in our array then true is returned and our else if condition executes the drawLine() function.
...
function disableClick() {
    ...
    //This makes our body clickable again afer 1 second
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //This line accesses the HTML canvaas element 
    const canvas = document.getElementById('win-lines');
    //This line gives us access to methods and properites to use on canvas
    const c = canvas.getContext('2d');
    //This line indicates where the start of a line x axis is
    let x1 = coordX1,
        //This line indicates where the start of a lines y axis is
        y1 = coordY1,
        //This line indicates where th end of a lines x axis is
        x2 = coordX2,
    ...
    function clear() {
        //This lien starts our animation loop
